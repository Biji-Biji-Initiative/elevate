...
vercel env add CLERK_WEBHOOK_SECRET production <<< "whsec_2v7DTTZcJytslXWs8SjOMfwjV+vmVeQvft7zHMJL5Zw="
...
vercel env add KAJABI_API_KEY production <<< "3bSjqrBysXjszB3TtFgSSKSV"
vercel env add KAJABI_CLIENT_SECRET production <<< "bEiFQSQiRzeyHZxfP4En52oo"
...
vercel env add RESEND_API_KEY production <<< "re_H7A8pYJd_9HD8ZuhNtUhTstgieKrj8cAf"
