...
echo "   • For local development: 'docker-compose up -d postgres'"
echo "   • For hosted PostgreSQL: Update DATABASE_URL in .env.local"
echo "3. Run 'pnpm db:init' to initialize the database"
