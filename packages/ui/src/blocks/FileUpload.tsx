...
export function FileUpload({
  ...
  const handleFileInput = useCallback(
    ...
    [handleFileValidation, onFileSelect, onValidationError],
  )
  ...
  return (
    <div
      ...
      aria-label={`Upload files. Accepted formats: ${accept}. Maximum size: ${Math.round(
        maxSizeBytes / (1024 * 1024),
      )}MB${multiple ? `. Up to ${maxFiles} files allowed` : ''}`}
    >
      <input
        ref={fileInputRef}
        type="file"
...
// UploadedFile type is sourced from @elevate/forms
