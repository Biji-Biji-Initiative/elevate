    ...
    it('should parse valid LEARN payload', () => {
      const payload = {
        ...
        data: {
          ...
          certificateFile: '/path/to/cert.pdf'
        }
      }
    ...
    it('should parse valid EXPLORE payload', () => {
      const payload = {
        ...
        data: {
          ...
          school: 'Test School',
          evidenceFiles: ['/path/to/evidence1.jpg', '/path/to/evidence2.pdf']
        }
      }
  ...
  describe('Schema Validation Edge Cases', () => {
    ...
    it('should validate numeric ranges correctly', () => {
      const invalidAmplify = {
        ...
        data: {
          peersTrained: 100, // Exceeds max of 50
          studentsTrained: 300 // Exceeds max of 200
        }
      }
