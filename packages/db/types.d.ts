...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly LedgerSource: readonly ["MANUAL", "WEBHOOK", "FORM"];
            readonly Role: readonly ["PARTICIPANT", "REVIEWER", "ADMIN", "SUPERADMIN"];
            readonly SubmissionStatus: readonly ["PENDING", "APPROVED", "REJECTED"];
            readonly Visibility: readonly ["PUBLIC", "PRIVATE"];
            readonly UserType: readonly ["EDUCATOR", "STUDENT"];
        };
    };
};
export {};
