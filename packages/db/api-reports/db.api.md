...
import { ActivityLeaderboardEntry } from '@elevate/types';
import { ActivityMetrics } from '@elevate/types';
import { AnalyticsCacheInfo } from '@elevate/types';
import { AnalyticsFilters } from '@elevate/types';
import { AnalyticsSummary } from '@elevate/types';
import { AuditLog } from '@prisma/client';
import { Badge } from '@prisma/client';
import { CohortComparison } from '@elevate/types';
import { CohortMetrics } from '@elevate/types';
import { DefaultArgs } from '@prisma/client/runtime/library';
import { EarnedBadge } from '@prisma/client';
import { KajabiEvent } from '@prisma/client';
import { LeaderboardEntry as LeaderboardEntry_2 } from '@elevate/types';
import { LedgerSource } from '@prisma/client';
import { PointsLedger } from '@prisma/client';
import { Prisma } from '@prisma/client';
import { PrismaClient } from '@prisma/client';
import { Role } from '@prisma/client';
import { SchoolMetrics } from '@elevate/types';
import { Submission } from '@prisma/client';
import { SubmissionAttachment } from '@prisma/client';
import { SubmissionStatus } from '@prisma/client';
import { TimeSeriesMetrics } from '@elevate/types';
import { User } from '@prisma/client';
import { UserActivityBreakdown } from '@elevate/types';
import { UserPointSummary } from '@elevate/types';
...
// @public
export function getUserActivityBreakdown(userId: string): Promise<UserActivityBreakdown[]>;
