...
describe('Security Middleware', () => {
  ...
  describe('createSecurityMiddleware', () => {
    ...
    it('should skip security headers for specified paths', () => {
      ...
      const staticRequest = new NextRequest('https://example.com/static/image.png');
      const normalRequest = new NextRequest('https://example.com/dashboard');

      const healthResponse = middleware(healthRequest);
      const staticResponse = middleware(staticRequest);
      const normalResponse = middleware(normalRequest);
  ...
  describe('withSecurity', () => {
    it('should combine security middleware with existing middleware', () => {
      const originalMiddleware = vi.fn((req: NextRequest) => {
      ...
      const response = combinedMiddleware(request);
    ...
    it('should pass security options to security middleware', () => {
      ...
      const combinedMiddleware = withSecurity(originalMiddleware, securityOptions);
      const request = new NextRequest('https://example.com/');
  ...
  describe('shouldBypassSecurity', () => {
    it('should bypass security for Next.js internals', () => {
      const nextInternalRequest = new NextRequest('https://example.com/_next/static/chunk.js');
      const apiNextRequest = new NextRequest('https://example.com/api/_next/webpack');
      const normalRequest = new NextRequest('https://example.com/dashboard');
