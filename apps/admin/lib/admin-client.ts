...
function validateAndExtract<TSchema extends z.ZodTypeAny>(
  response: unknown,
  schema: TSchema,
  context: string
): z.infer<TSchema>['data'] {
  try {
    ...
    if (error instanceof z.ZodError) {
      throw new AdminClientError(`Invalid response format in ${context}: ${error.message}`, error)
    }
...
// Utility to clean query parameters
...
export const adminClient = {
  async getCohorts(): Promise<string[]> {
    try {
      ...
      return validateAndExtract(response, CohortsResponseSchema, 'getCohorts').cohorts
    } catch (error) {
  ...
  async getSubmissions(params: SubmissionsQuery = {}): Promise<{ submissions: AdminSubmission[]; pagination: Pagination }> {
    try {
      ...
      return validateAndExtract(response, SubmissionsListResponseSchema, 'getSubmissions')
    } catch (error) {
  ...
  async reviewSubmission(body: { 
    ...
    try {
      ...
      return validateAndExtract(response, ReviewResponseSchema, 'reviewSubmission')
    } catch (error) {
  ...
  async bulkReview(body: { 
    ...
    try {
      ...
      return validateAndExtract(response, BulkReviewResponseSchema, 'bulkReview')
    } catch (error) {
      throw new AdminClientError('Failed to bulk review submissions', error)
    }
  },

  async getSubmissionById(id: string): Promise<{ submission: AdminSubmission; evidence?: string }> {
    try {
      const api = getApiClient()
      const response = await api.getAdminSubmissionById(id)
      return validateAndExtract(response, SubmissionDetailResponseSchema, 'getSubmissionById')
    } catch (error) {
  ...
  async updateUser(body: { 
    ...
    try {
      ...
      return validateAndExtract(response, UpdateUserResponseSchema, 'updateUser')
    } catch (error) {
  ...
  async bulkUpdateUsers(body: { 
    ...
    try {
      ...
      return validateAndExtract(response, BulkUpdateUsersResponseSchema, 'bulkUpdateUsers')
    } catch (error) {
  ...
  async createBadge(body: { 
    ...
    try {
      ...
      return validateAndExtract(response, BadgeOperationResponseSchema, 'createBadge')
    } catch (error) {
  ...
  async updateBadge(body: { 
    ...
    try {
      ...
      return validateAndExtract(response, BadgeOperationResponseSchema, 'updateBadge')
    } catch (error) {
  ...
  async deleteBadge(code: string): Promise<{ message: string }> {
    try {
      ...
      return validateAndExtract(response, BadgeOperationResponseSchema, 'deleteBadge')
    } catch (error) {
  ...
  async assignBadge(body: { 
    ...
    try {
      ...
      return validateAndExtract(response, BadgeOperationResponseSchema, 'assignBadge')
    } catch (error) {
  ...
  async removeBadge(body: { 
    ...
    try {
      ...
      return validateAndExtract(response, BadgeOperationResponseSchema, 'removeBadge')
    } catch (error) {
  ...
  async getAnalytics(params: AnalyticsQuery = {}): Promise<{
    ...
    try {
      ...
      return validateAndExtract(response, AnalyticsResponseSchema, 'getAnalytics')
    } catch (error) {
  ...
  async reprocessKajabi(body: { event_id: string }): Promise<{ message: string }> {
    try {
      const api = getApiClient()
      const response = await api.reprocessAdminKajabi(body)
      return validateAndExtract(response, BadgeOperationResponseSchema, 'reprocessKajabi')
    } catch (error) {
