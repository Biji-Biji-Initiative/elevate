/**
 * Type-safe fetch wrapper for the admin application
 ...
 * })
 * 
 * const submission = await typedFetch('/api/admin/submissions/123', submissionSchema)
 * // submission is now properly typed
 * ```
 */
...
export const adminSchemas = {
  /**
   * Standard admin success response
   */
  success: z.object({
    success: z.boolean(),
  ...
  /**
   * Paginated response wrapper for admin data
   */
