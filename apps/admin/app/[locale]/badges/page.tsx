  ...
  const columns = createColumns<Badge>()([
    {
      key: 'name',
      header: 'Badge',
      accessor: (row: Badge) => ({ name: row.name, code: row.code, icon_url: row.icon_url ?? '' }),
      sortAccessor: (row: Badge) => row.name,
      render: (row: Badge) => (
    ...
    },
    {
      key: 'description',
      header: 'Description',
      accessor: (row: Badge) => row.description,
      render: (row: Badge) => (
    ...
    },
    {
      key: 'criteria.type',
      header: 'Type',
      accessor: (row: Badge) => row.criteria.type,
      render: (row: Badge) => (
    ...
    },
    {
      ...
      header: 'Threshold',
      accessor: (row: Badge) => ({ threshold: row.criteria.threshold, type: row.criteria.type }),
      sortAccessor: (row: Badge) => row.criteria.threshold,
      render: (row: Badge) => (
    ...
    },
    {
      ...
      header: 'Earned',
      accessor: (row: Badge) => row._count?.earned_badges ?? 0,
      render: (row: Badge) => (
