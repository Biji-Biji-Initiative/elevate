...
import { FormField, Select, LoadingSpinner, Alert } from '@elevate/ui/FormField'
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            >
              <Select
                ...
                onChange={(value) => setValue('provider', value as 'SPL' | 'ILS')}
                placeholder="Select your training provider"
